...
import { TIOL_EMAIL } from "../helpers/constants";
    ...
    try {
        ...
        switch (template) {
            ...
            case "REG":
                ...
                attachments = [...memberTemplateAttachments];
                mailTemplate = "nomineeApplicationTemplate"
                break;
            case "NON-REG":
                MailConfig.ViewOption(gmailTransport, hbs);
                subject = "You have been nominated!";
            ...
            case "VTL":
                MailConfig.ViewOption(gmailTransport, hbs);
                subject = "You have been selected for nomination!";
                attachments = [...memberTemplateAttachments];
                mailTemplate = "votingTemplate"
                break;
