...
import { createUniqueSurveyQuestionCode } from "../helpers/codeHelper";

exports.fetch_all_survey_question = async (req, res, next) => {
    try {
        let fetchAllSurveyQuestions = await db.SurveyQuestion.findAll({});
...
exports.create_new_survey_question = async (req, res, next) => {
    try {
        ...
        const code = await createUniqueSurveyQuestionCode();
        ...
        let new_surveyQuestion = await db.SurveyQuestion.create({
...
exports.update_survey_question = async (req, res, next) => {
    try {
        ...
        let updatedSurveyQuestion = await db.SurveyQuestion.findOne({
            where: {
                id: id
            }
        });
...
exports.fetch_survey_question_by_master_sub_category_id = async (req, res, next) => {
    try {
        ...
        let findSurveyQuestion = await db.SurveyQuestion.findAll({
            where: {
